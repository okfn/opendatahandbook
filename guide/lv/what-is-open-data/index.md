...
-   **Universal Dalība:** everyone must be able to use, re-use and redistribute - there should be no discrimination against fields of endeavour or against persons or groups. For example, ‘non-commercial’ restrictions that would prevent ‘commercial’ use, or restrictions of use for certain purposes (e.g. only in education), are not allowed.
...
Savietojamība apzīmē dažādu sistēmu un organizāciju spēju strādāt kopā (būt savietojamiem). Šajā gadījumā tā ir spēja savienot vai sakrustot dažādas datu kopas.
...
Līdzīgi, dažiem no valsts datiem, var būt ierobežojumi, kas ir saistīti ar nacionālo drošību .
